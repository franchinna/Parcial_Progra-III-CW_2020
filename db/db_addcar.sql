...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2020 a las 03:46:50
...
INSERT INTO `autos_marcas` (`id_autos`, `nombre`, `slug`) VALUES
(1, 'Abarth', 'abarth'),
...
INSERT INTO `autos_modelos` (`id_modelo`, `nombre`, `slug`, `id_autos`) VALUES
(1, '500', '500', 1),
...
ALTER TABLE `autos_marcas`
  ...
  ADD UNIQUE KEY `nombre_slug_UNIQUE` (`slug`),
  ADD UNIQUE KEY `nombre_marca_UNIQUE` (`nombre`);
...
ALTER TABLE `autos_modelos`
  ...
  ADD UNIQUE KEY `id_modelo_UNIQUE` (`id_modelo`),
  ADD UNIQUE KEY `nombre_modelo_UNIQUE` (`nombre`),
  ADD UNIQUE KEY `modelo_slug_UNIQUE` (`slug`),
  ADD KEY `fk_autos_modelo_autos_idx` (`id_autos`);
...
--
ALTER TABLE `autos_marcas`
  MODIFY `id_autos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT de la tabla `autos_modelos`
--
ALTER TABLE `autos_modelos`
  MODIFY `id_modelo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1006;
...
--
-- Filtros para la tabla `autos_modelos`
--
ALTER TABLE `autos_modelos`
  ADD CONSTRAINT `fk_autos_modelo_autos` FOREIGN KEY (`id_autos`) REFERENCES `autos_marcas` (`id_autos`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
